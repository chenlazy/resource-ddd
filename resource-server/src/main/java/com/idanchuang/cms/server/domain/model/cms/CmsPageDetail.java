...
public class CmsPageDetail {
    ...
    @ApiModelProperty(value = "容器id合集")
    private List<String> sort;

    @ApiModelProperty(value = "页面样式 容器列表合计")
    private String pageStyle;

    @ApiModelProperty(value = "是否分享 1-是 0-否")
    private Integer shareFlag;

    @ApiModelProperty(value = "分享图片具体信息")
    private List<CmsCoreShareImg> shareImgs;
